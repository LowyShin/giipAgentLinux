...
| 문서 | 용도 |
|------|------|
| **[GATEWAY_HANG_DIAGNOSIS.md](GATEWAY_HANG_DIAGNOSIS.md)** | Architecture 필수 이해 |
| **[AUTO_DISCOVER_LOGGING_DIAGNOSIS.md](AUTO_DISCOVER_LOGGING_DIAGNOSIS.md)** | Discovery 진단 |
| **[AUTO_DISCOVER_LOGGING_ENHANCED.md](AUTO_DISCOVER_LOGGING_ENHANCED.md)** | 로깅 구현 |
| **[MODULAR_ARCHITECTURE.md](MODULAR_ARCHITECTURE.md)** | 모듈 설계 |
| **[SHELL_COMPONENT_SPECIFICATION.md](SHELL_COMPONENT_SPECIFICATION.md)** | 컴포넌트 표준 |
| **⭐ [KVS_STORAGE_STANDARD.md](KVS_STORAGE_STANDARD.md)** | **KVS 데이터 저장 표준** |
